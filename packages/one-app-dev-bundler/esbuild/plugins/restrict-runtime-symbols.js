...
const isNodeForExternals = (node, ancestors) => {
  ...
  // when checking if a module is providing externals with this expression, look up
  // for the assignment, as it's the 'root' node for the entire expression that needs
  // to be checked

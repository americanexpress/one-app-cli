...
// But in the test we can assume that the webpack config returned some POJO
jest.mock('module', () => ({
...
describe('logging helpers', () => {
  ...
  beforeEach(() => {
    ...
    // reconstruct the createRequire mock chain so we can check the params are all correct

...
// this needs to be a require, not an import. This is probably because this file is deep in a folder
...
// The source code for the 'module' that will be bundled then tested in this file
...
describe('the output from dev-websocket-injector', () => {
  ...
  beforeEach(async () => {
    ...
    // build the code to transpile it to something that can be imported
    ...
    // Require the file to get a hold of the generated default export,
    // this is what this needs to be tested

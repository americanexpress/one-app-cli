...
// plugin, and the injectors it composes, gather information from places we can't, such as the
// module thats running it.

// Mock things that we cant do properly during jest tests
jest.mock('../../../esbuild/utils/get-meta-url.mjs', () => () => 'mockMetaUrl');

// Mock things that we usually load from the modules package.json
...
describe('Esbuild plugin oneAppIndexLoader', () => {
  ...
  describe('lifecycle Hooks', () => {
    ...
    it('should throw an exception if an injector removes the default export', async () => {
      ...
      // it doesnt matter which we mock here.

...
!function (e, n) {
  ...
  function E(e, i) {
    void 0 === e && (e = []), void 0 === i && (i = function i() {});
    var n,
  ...
  a() ? C(["onunhandledrejection", "onerror", "oninstall", "onactivate", "onmessage", "onfetch", "onsync", "onpush", "onnotificationclick", "onnotificationclose"]) : u() && (R("registration", function (e) {
    ...
    "function" == typeof t ? r = t : t instanceof RegExp && (r = function r(e) {
      var n = e.request.url;
      return t.test(n);
    });
    var i,
    ...
    return function (a, e) {
      if (r(a)) return e.set("cacheName", c), e.set("request", a.request.clone()), a.respondWith(L(a.request.clone()).then(function (e) {
        return e || (n = {
          waitUntil: function waitUntil(e) {
    ...
    return void 0 === a && (a = function a(e) {
      ...
      e.data && (r = (t = "json" in e.data ? e.data.json() : e.data)[o()], i = function (e, n) {
        ...
        for (var r in e) {
          Object.prototype.hasOwnProperty.call(e, r) && -1 === n.indexOf(r) && (t[r] = e[r]);
        }
...
function serviceWorkerClient(_ref) {
  var scope = _ref.scope,
      scriptUrl = _ref.scriptUrl,
      webManifestUrl = _ref.webManifestUrl,
      offlineUrl = _ref.offlineUrl,
      onError = _ref.onError;
  // We listen for any messages that come in from the service worker
  Object(_americanexpress_one_service_worker__WEBPACK_IMPORTED_MODULE_0__["on"])('message', [Object(_americanexpress_one_service_worker__WEBPACK_IMPORTED_MODULE_0__["messageContext"])(), Object(_americanexpress_one_service_worker__WEBPACK_IMPORTED_MODULE_0__["messenger"])(_defineProperty({}, _constants__WEBPACK_IMPORTED_MODULE_1__["ERROR_MESSAGE_ID_KEY"], onError))]);
  Object(_americanexpress_one_service_worker__WEBPACK_IMPORTED_MODULE_0__["on"])('register', function () {
    ...
    Object(_americanexpress_one_service_worker__WEBPACK_IMPORTED_MODULE_0__["match"])(offlineUrl).then(function (response) {
      if (!response) fetch(offlineUrl);
    });
    Object(_americanexpress_one_service_worker__WEBPACK_IMPORTED_MODULE_0__["match"])(webManifestUrl).then(function (response) {
 ...
 */
// messaging keys
var ERROR_MESSAGE_ID_KEY = 'error'; // cache names

var OFFLINE_CACHE_NAME = 'offline';

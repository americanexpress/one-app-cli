...
Promise.all([
  webpack(config('modern')).then((stats) => getWebpackCallback('browser')(undefined, stats)),
  webpack(config('legacy')).then((stats) => getWebpackCallback('legacyBrowser')(undefined, stats)),
